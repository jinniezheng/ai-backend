package com.jrcc.ai.front.service.strategy.user;
...
import com.jrcc.ai.base.domain.entity.EmailVerifyCodeDO;
...
import com.jrcc.ai.front.constant.FrontConstant;
...
import com.jrcc.ai.front.service.*;
...
import static com.jrcc.ai.base.constant.ApplicationConstant.FRONT_JWT_EXTRA_USER_ID;
import static com.jrcc.ai.base.constant.ApplicationConstant.FRONT_JWT_USERNAME;
...
public class EmailAbstractRegisterStrategy extends AbstractRegisterTypeStrategy {
    ...
    public void checkVerifyCode(String identity, String verifyCode) {
        ...
        //设置用户剩余时间和次数
        ChatUserLimitBo chatUserLimitBo = new ChatUserLimitBo();
        chatUserLimitBo.setLimitAmout(FrontConstant.REGISTER_USER_LIMIT_AMOUNT);
        chatUserLimitBo.setUserId(FrontUserUtil.getUserId().longValue());
        chatUserLimitBo.setLimitTime(new Date());
        chatUserLimitService.insertByBo(chatUserLimitBo);
    }
